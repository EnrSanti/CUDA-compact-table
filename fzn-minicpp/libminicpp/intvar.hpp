...
public:
   ...
   void dumpInSparseBitSet(int index,int offset,int min, int intialMin,int max, SparseBitSet & dump) const override { _dom->dumpInSparseBitSet(index,offset,min,intialMin,max,dump);};
